    ...
    <div className="min-h-screen p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="h-48 sm:h-64 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900 flex items-center justify-center">
                <div className="text-center">
                  <FaCamera className="text-3xl sm:text-4xl text-gray-400 dark:text-gray-500 mx-auto mb-3 sm:mb-4" />
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 sm:p-8 border border-blue-200 dark:border-blue-800">
            <FaImages className="text-3xl sm:text-4xl text-blue-500 dark:text-blue-400 mx-auto mb-3 sm:mb-4" />
