      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="space-y-8">
                          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 lg:p-8">
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6">Get in Touch</h2>
                
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#efac38] rounded-lg flex items-center justify-center">
                      <FaEnvelope className="text-white text-base sm:text-lg" />
                    </div>
                    <div>
                      <h3 className="text-white font-semibold text-sm sm:text-base">Email</h3>
                      <p className="text-white/70 text-sm sm:text-base">info@kvaudio.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm sm:text-base">+94 11 234 5678</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm sm:text-base">123 Audio Street, Colombo, Sri Lanka</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm sm:text-base">Mon - Fri: 9:00 AM - 6:00 PM</p>
                      <p className="text-white/70 text-sm sm:text-base">Sat: 9:00 AM - 4:00 PM</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 sm:p-6 lg:p-8">
              ...
              <div className="w-full h-48 sm:h-64 bg-gray-300 rounded-lg flex items-center justify-center">
                <p className="text-gray-600 text-sm sm:text-base">Map placeholder - Add your map integration here</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  name="email"
                  required
                  className="w-full h-[45px] sm:h-[50px] bg-white/20 border-2 border-white/30 rounded-lg text-white text-sm sm:text-lg px-4 outline-none focus:border-[#efac38] transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full bg-white/20 border-2 border-white/30 rounded-lg text-white text-sm sm:text-lg px-4 py-3 outline-none focus:border-[#efac38] transition-colors resize-none"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-[45px] sm:h-[50px] bg-[#efac38] text-white text-sm sm:text-lg font-semibold rounded-lg hover:bg-[#efac38]/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                <FaPaperPlane />
