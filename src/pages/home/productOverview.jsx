      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
              ...
              <div className="grid grid-cols-4 gap-2 sm:gap-4">
                {product.image.map((image, index) => (
                  <button
                    ...
                    className={`h-16 sm:h-20 lg:h-24 rounded-lg overflow-hidden border-2 transition-all ${
                      selectedImage === index 
                        ? "border-blue-500" 
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* Product Name */}
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">{product.name}</h1>
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16">
          ...
          {reviews.length === 0 ? (
            <div className="text-center py-8 sm:py-12">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Be the first to review this product!</p>
            </div>
          ) : (
