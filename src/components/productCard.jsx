  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <Link
              ...
              className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
              title="View Details"
            >
              <FaEye className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm" />
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6 pt-0">
        <Link
          to={`/product/${product.key}`}
          className="block w-full bg-blue-600 text-white text-center py-2 sm:py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-sm sm:text-base"
        >
          View Details
        </Link>
      </div>
